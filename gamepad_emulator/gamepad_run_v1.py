...
INIT_BASELINE = np.array([
    -0.05084747076034546, -0.05084747076034546, 0.0, -0.7368420958518982,
     0.736842155456543, 0.0625, 0.0625, 0.0, 0.0, -1.0, 1.0,
    -0.9512194991111755, -0.9512194991111755, 0.0, 0.0,
     0.2857142686843872, 0.2857142686843872,
     0.7333333492279053, 0.7333333492279053,
     0.0, 0.0, 0.0, 0.0
], dtype=np.float32)
