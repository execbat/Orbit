...
from isaaclab_tasks.manager_based.locomotion.velocity.velocity_env_cfg import LocomotionVelocityRoughEnvCfg, RewardsCfg, MathRewardsCfg,  MathLocomotionVelocityRoughEnvCfg, MathTeleopLocomotionVelocityRoughEnvCfg
...
###
@configclass
class MathG1Rewards(MathRewardsCfg):
...
@configclass
class MathG1RoughEnvCfg(MathLocomotionVelocityRoughEnvCfg):
    rewards: G1Rewards = MathG1Rewards()
...
@configclass
class MathTeleopG1RoughEnvCfg_PLAY(MathTeleopLocomotionVelocityRoughEnvCfg):
    rewards: G1Rewards = MathG1Rewards()
