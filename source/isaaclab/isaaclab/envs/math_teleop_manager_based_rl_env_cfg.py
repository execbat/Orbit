...
from .ui import MathManagerBasedRLEnvWindow
...
@configclass
class MathTeleopManagerBasedRLEnvCfg(MathManagerBasedEnvCfg):
    """Configuration for a reinforcement learning environment with the manager-based workflow."""

    # ui settings
    ui_window_class_type: type | None = MathManagerBasedRLEnvWindow
