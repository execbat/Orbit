...
from .math_base_env_window import MathBaseEnvWindow

if TYPE_CHECKING:
    from ..math_manager_based_rl_env import MathManagerBasedRLEnv


class MathManagerBasedRLEnvWindow(MathBaseEnvWindow):
    ...
    def __init__(self, env: MathManagerBasedRLEnv, window_name: str = "IsaacLab"):
