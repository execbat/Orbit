...
from .math_command import UniformVectorCommand, BernoulliMaskCommand
...
class BernoulliMaskCommandCfg(CommandTermCfg):
    ...
    class Ranges:
        ...
        tgt_mask_ax_10: tuple[float, float] = MISSING
        tgt_mask_ax_11: tuple[float, float] = MISSING
        tgt_mask_ax_12: tuple[float, float] = MISSING
        tgt_mask_ax_13: tuple[float, float] = MISSING
        tgt_mask_ax_14: tuple[float, float] = MISSING
        tgt_mask_ax_15: tuple[float, float] = MISSING
        tgt_mask_ax_16: tuple[float, float] = MISSING
        tgt_mask_ax_17: tuple[float, float] = MISSING
        tgt_mask_ax_18: tuple[float, float] = MISSING
        tgt_mask_ax_19: tuple[float, float] = MISSING
        tgt_mask_ax_20: tuple[float, float] = MISSING
        tgt_mask_ax_21: tuple[float, float] = MISSING
        tgt_mask_ax_22: tuple[float, float] = MISSING
        tgt_mask_ax_23: tuple[float, float] = MISSING
...
class UniformVectorCommandCfg(CommandTermCfg):
    ...
    class Ranges:
        ...
        tgt_norm_ax_10: tuple[float, float] = MISSING
        tgt_norm_ax_11: tuple[float, float] = MISSING
        tgt_norm_ax_12: tuple[float, float] = MISSING
        tgt_norm_ax_13: tuple[float, float] = MISSING
        tgt_norm_ax_14: tuple[float, float] = MISSING
        tgt_norm_ax_15: tuple[float, float] = MISSING
        tgt_norm_ax_16: tuple[float, float] = MISSING
        tgt_norm_ax_17: tuple[float, float] = MISSING
        tgt_norm_ax_18: tuple[float, float] = MISSING
        tgt_norm_ax_19: tuple[float, float] = MISSING
        tgt_norm_ax_20: tuple[float, float] = MISSING
        tgt_norm_ax_21: tuple[float, float] = MISSING
        tgt_norm_ax_22: tuple[float, float] = MISSING
        tgt_norm_ax_23: tuple[float, float] = MISSING
