...
class MathManagerBasedEnv:
    ...
    * **Recorder Manager**: The recorder manager that handles recording data produced during different steps
    ...
    def __init__(self, cfg: MathManagerBasedEnvCfg):
    ...
    def load_managers(self):
        ...
        if self.__class__ == MathManagerBasedEnv and "startup" in self.event_manager.available_modes:
